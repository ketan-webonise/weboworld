...
class ImportController < ApplicationController
  ...
  def authorise
    begin
      ...
      request.set_form_data('code' => token, 'client_id' => client_id, 'client_secret' => client_secret, 'redirect_uri' => googleauth_import_index_url, 'grant_type' => 'authorization_code')
      ...
      emails.each do |email|
        InviteFriend.create(:friend_email => email,:user_id => current_user.id, :name => email[/[^@]+/])
